...
1.  Mở file `index.html` bằng browser hoặc truy cập đường link: https://remotewebapp.netlify.app/ (cần Allow Insecure content (nội dung không an toàn) ở Site settings).
